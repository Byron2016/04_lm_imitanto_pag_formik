      ...
      <div id="slider" className="carousel slide" data-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              className="img-fluid"
              src="https://blog.nubecolectiva.com/wp-content/uploads/2019/10/img_destacada_blog_devs-5-930x360.png"
            />
          ...
          <div className="carousel-item">
            <img
              className="img-fluid"
              src="https://blog.nubecolectiva.com/wp-content/uploads/2019/08/edit_img_destacada_blog_devs-930x360.png"
            />
            <div className="elementos">
              <a
                className="btn btn-lg btn-primary"
